...
frame_table = tk.Frame(window, width = 700, height = 300, bg = 'green')
...
salery_box = tk.Label(frame_statistics, text = "6340", font = ("Sylfaen", 10))
salery_box.pack()
...
all_time_box = tk.Label(frame_statistics, text = "264", font = ("Sylfaen", 10))
all_time_box.pack()
